...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceHandlerRequest<ResourceModel> request = ResourceHandlerRequest.<ResourceModel>builder()
            ...
            .build();
        when(proxyClient.client().batchDeleteFeaturedResultsSet(any(
            BatchDeleteFeaturedResultsSetRequest.class))).thenReturn(
            BatchDeleteFeaturedResultsSetResponse.builder().build());
    ...
    public void handleRequest_ServiceException() {
        ...
        when(proxyClient.client().batchDeleteFeaturedResultsSet(any(BatchDeleteFeaturedResultsSetRequest.class)))
